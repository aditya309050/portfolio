    ...
    <>
      ...
      <section className="list-section">
        ...
        <div id="exp-list">
          ...
          <div className="exp-list-item"><span className="eli-num">PRJ</span><span className="eli-name"><span className="eli-chip" style={{background: 'var(--blue)'}}></span>Backend</span><span className="eli-cat">React / Strapi</span><span className="eli-year">2024</span><span className="eli-arrow">↗</span></div>
